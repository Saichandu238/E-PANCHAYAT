...
<body>
    ...
    <div class="info-and-stats">
        <div class="info-box">
            <h3>Problems Reported by the Members of <?php echo "$Village" ?> Village</h3>
            <table class="stats">
                <tr>
                    <th>ID</th>
                    <th>Name</th>
...
// Sanitize the $Village variable to prevent SQL injection
// $Village = $conn->real_escape_string($Village);
// Query to fetch data
// echo "$Village";

$sql = "SELECT * FROM Problem WHERE Village= '$Village'" ;
