...
?>
        ...
        <div class="info-box">
            <h3>District Revenue Officer(DRO) details of <?php echo "$District"; ?></php> District</h3>
            <table class="stats">
                <tr>
                    <th>Name</th>
                    <th>Aadhar_Number</th>
...
$sql = "SELECT  Name, Aadhar_Number, DOB, Joining_date, Village, Mandal, District, Gmail
 FROM dro_details
