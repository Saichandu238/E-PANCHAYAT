...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        if ($stmt->affected_rows > 0) {
            $deletion_message = "user details with user ID $WardMember_id have been successfully deleted.";
        } else {
            $deletion_message = "No user  found with wardmember id $WardMember_id.";
        }
    } else {
