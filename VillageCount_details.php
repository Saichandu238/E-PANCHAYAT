...
<body>
    <div class="header">
        <div class="header-content">
            ...
            <div class="header-text">
                ...
                <h2>Welcome to <?php echo "$Name"; ?></php>, Member of <?php echo "$Village "; ?></php> Village</h2>
            </div>
    ...
    <div class="links">
        ...
        <a href="Userdata_Admin.php">View Users data</a>

        <div class="dropdown">
            <a href="#" class="dropbtn">Village Details</a>
            <div class="dropdown-content">
                <a href="VillageCount_details.php">View Village Count</a>
                <a href="WorkersDetails.html">View GramPanchyat Workers</a>
                <a href="OtherDetails.html">Other details</a>
            </div>
        </div>
        <div class="dropdown">
            <a href="#" class="dropbtn">Update Village Details</a>
            <div class="dropdown-content">
                <a href="LiteracyRate.html">Edit Literacy Rate</a>
                <a href="SchoolDetails.html">edit Number of Schools</a>
                <a href="VotersList.html">edit Voters List</a>
                <a href="WorkersDetails.html">edit GramPanchyat Workers</a>
                <a href="OtherDetails.html">edit other details</a>
            </div>
        </div>

        <div class="dropdown">
            <a href="#" class="dropbtn">Report Problem</a>
            <div class="dropdown-content">
                <a href="Problem.html">Report a Problem</a>
                <a href="ViewProblems.html">View Problems</a>
                <a href="Complent.html">Report a Complaint</a>
                <a href="FileCase.html">File a Case</a>
            </div>
        </div>
        ...
        <div class="dropdown">
            <a href="#" class="dropbtn">List of Politicians</a>
            <div class="dropdown-content">
                <a href="SRO.html">SRO's List</a>
                <a href="DRO.html">DRO's List</a>
                <a href="MRO.html">MRO's List</a>
                <a href="SerpanchList.html">Serpanch List</a>
                <a href="WardMemberList.html">Ward Member's List</a>
            </div>
        </div>
    </div>
