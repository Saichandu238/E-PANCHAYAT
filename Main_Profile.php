...
<head>
    ...
    body {
        ...
        /* background-image: url("http://localhost/Mini_Project/Images/T22.jpg"); */
        width: 100%;
        /* Adjust as needed */
        height: 100%;
        /* Adjust as needed */
...
<body>
    ...
    <div class="info-and-stats">
        <div class="info-box">
            <h3>SRO Details of Telangana State</h3>
            <table class="stats">
                <tr>
...
if ($result->num_rows > 0) {
    ...
    echo "<tr><td colspan='15'>No Serpanch data available</td></tr>";
}
...
?>
        ...
        <div class="info-box">
            <h3>Manager Details of Telangana State</h3>
            <table class="stats">
                <tr>
                    <th>Manager Id</th>
                    <th>Name</th>
...
$sql = "SELECT * FROM managerlogindetails";
