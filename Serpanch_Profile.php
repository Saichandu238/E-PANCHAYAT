               ...
               <body>
                   <div class="header">
                       <div class="header-content">
                           <img src="http://localhost/Mini_Project/Images/EPM3.jpg" width="120" height="120"
                               alt="E-Panchayat">
                           ...
                           <img src="http://localhost/Mini_Project/Images/Emblem%20of%20Telengana%20(1).jpg" width="120"
                               height="120" alt="Telangana logo">
                       </div>
                   </div>
                   ...
                   <div class="links">
                       <a href="Home_Page.html">
                           <img src="http://localhost/Mini_Project/Images/HSymbol.jpg" width="25" height="25"
                               alt="Home">
                       </a>
        ...
        ?>
            ...
            //    $FCS = $_SESSION['FCS'];
               ...
               if ($result->num_rows > 0) {
                ...
                $sql = "SELECT  Name, Joining_date, Village, Mandal, District
                    FROM mro_details
                    WHERE Mandal = '$Mandal'";
