...
$sql = "SELECT COUNT(*) AS totalFamilies FROM family_details WHERE Mandal = '$Mandal'";
...
$sql = "SELECT FamilyMembers FROM family_details WHERE Mandal = '$Mandal'";
$stmt = $conn->prepare($sql);
$stmt->execute();
...
$sql = "SELECT SUM(Voters) AS totalVoters FROM family_details WHERE Mandal = '$Mandal'";
$stmt = $conn->prepare($sql);
$stmt->execute();
$totalVoters = $stmt->fetch(PDO::FETCH_ASSOC)['totalVoters'];

// SQL query to get the sum of educated people for the entire dataset
$sql = "SELECT SUM(Education) AS totalLiterature FROM family_details WHERE Mandal = '$Mandal'";
$stmt = $conn->prepare($sql);
$stmt->execute();
    ...
    <body>
        <div class="profile-container">
            <table class="profile-table">
                ...
                <caption><?php echo "$Mandal" ?> Mandal Data</caption>
                <tr>
                    <th>Metric</th>
                    <th>Value</th>
                </tr>
                <tr>
                    <td>Total Number of Families Registered in <?php echo "$Mandal"; ?></php>
                    </td>
                    <td><?php echo $totalFamilies; ?></td>
                </tr>
                <tr>
                    <td><?php echo "$Mandal"; ?></php> District Population</td>
                    <td><?php echo $totalFamilyMembers; ?></td>
                </tr>
                <tr>
                    <td>Total Number of Voters in <?php echo "$Mandal"; ?></php>
                    </td>
                    <td><?php echo $totalVoters; ?></td>
                </tr>
                <tr>
                    <td>Total Number of Educated People in <?php echo "$Mandal"; ?></php>
                    </td>
                    <td><?php echo $totalLiterature; ?></td>
                </tr>
                <tr>
                    <td>Literacy Rate in <?php echo "$Mandal"; ?></php>
                    </td>
