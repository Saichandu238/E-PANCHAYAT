...
<head>
    ...
    <title>Update MRO Details</title>
    <style>
    body {
...
<body>
    ...
    if ($mro) {
        ?>
        <form action="UpdateMRO_details2.php" method="POST">
            ...
            <input type="text" id="Aadhar Number" name="Aadhar_Number"
                value="<?php echo htmlspecialchars($mro['Aadhar_Number']); ?>" required>
            ...
            <input type="date" id="JoiningDate" name="Joining_date"
                value="<?php echo htmlspecialchars($mro['Joining_date']); ?>" required>
            ...
            <input type="text" id="Mail_id" name="Mail_id" value="<?php echo htmlspecialchars($mro['Gmail']); ?>"
                required>

            <label for="Password">Password</label>
            <input type="text" id="Password" name="Password" value="<?php echo htmlspecialchars($mro['Password']); ?>"
                required>
        ...
        echo "<p>Mandal Revenue Officer(MRO) not found. <a href='MRO_Profile.php'>Click here to go back</a></p>";
