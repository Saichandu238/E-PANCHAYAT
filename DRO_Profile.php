...
<head>
    ...
    body {
        ...
        /* height: 100%; */
        /* Adjust as needed */
        /* background-image: url("http://localhost/Mini_Project/Images/Homepage2.jpg");
...
<body>
    ...
    <div class="info-and-stats">
        <div class="info-box">
            <h3>Mandal Revenue Officer(MRO) Details of <?php echo "$District" ?> District</h3>
            <table class="stats">
                <tr>
                    <th>Employee Id</th>
                    <th>Name</th>
...
$sql = "SELECT * FROM mro_details where District='$District'";
