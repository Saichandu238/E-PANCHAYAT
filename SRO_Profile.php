...
<body>
    ...
    <div class="info-and-stats">
        <div class="info-box">
            <h3>Superior Details of State</h3>
            <table class="stats">
                <tr>
...
// Query to fetch data
$sql = "SELECT * FROM mainlogindetails";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr>";
        // echo "<td>" . $row["Authentication_id"] . "</td>";
        echo "<td>" . $row["Name"] . "</td>";
    ...
    echo "<tr><td colspan='10'>No DROs data available</td></tr>";
}
...
?>
        ...
        <div class="info-box">
            <h3>Executive Details of State</h3>
            <table class="stats">
                <tr>
                    <!-- <th>Manager Id</th> -->
                    <th>Name</th>
