...
background-color: #f9f9f9; /* Light background color for the entire table */
...
.stats th {
background-color: whitesmoke; /* Darker background color for table headers */
color: blueviolet; /* White text for table headers */
font-weight: bold;
text-align: left;
padding: 10px; /* More padding for table headers */
/* border: 1px solid black; */
}

.stats td {
background-color: lightblue; /* White background color for table data */
color: blue; /*Dark grey text for table data */
padding: 10px; /* Padding for table data cells */
border: 0px solid black; /* Lighter border color */
...
<div class="header">
        ...
        <h2>Welcome to <?php echo "$Name"; ?></php> DRO of <?php echo "$District"; ?></php> </h2>
        </div>
        <img src="http://localhost/Mini_Project/Images/Emblem%20of%20Telengana%20(1).jpg" width="120" height="120" alt="Telangana logo">
        </div>
        </div>

    <!-- Links Section -->
    <div class="links">
        <a href="DRO_Profile.php">
...
<div class="info-box">
<h3>Ward-Member Details of State</h3>
<table class="stats">
<tr>
<th>WardMember ID</th>
<th>Name</th>
...
$sql = "SELECT * FROM wardmemberdetails" ;
