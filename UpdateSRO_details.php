...
<head>
    ...
    <title>Update SRO Details</title>
    <style>
    body {
...
<body>
    ...
    if ($mro) {
        ?>
        <form action="updateSRO_details2.php" method="POST">
        ...
        echo "<p>SRO not found. <a href='SRO_Profile.html'>Click here to go back</a></p>";
