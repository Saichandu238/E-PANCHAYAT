...
if (isset($_SESSION['Serpanch_id'], $_SESSION['Name'], $_SESSION['Aadhar_Number'], $_SESSION['Village'], $_SESSION['Mandal'], $_SESSION['District'], $_SESSION['Gmail'], $_SESSION['Number'])) {
    ...
    // Execute the query
    if ($stmt->execute()) {
        echo "<p>Details recorded successfully. <a href='Serpanch_Profile.php'>Click here to go back</a></p>";
