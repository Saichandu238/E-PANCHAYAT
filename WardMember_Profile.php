...
// Debugging District value
// echo "District: " . $user['District']; // Check if District is fetched correctly
?>
<!-- $_SESSION['ID'] = $user['ID'];
            ...
            $_SESSION['District']=$user['Disrict'];
...
<body>
    ...
    <div class="info-and-stats">
        <div class="info-box">
            <h3>Serpanch Details of <?php echo "$Village"; ?></php> Village</h3>
            <table class="stats">
                <tr>
                    <th>Name</th>
                    <th>Joining Date</th>
...
// Query to fetch data
$sql = "SELECT * FROM serpanchdetails WHERE Village = '$Village'";
...
$sql = "SELECT * FROM wardmemberdetails WHERE Village = '$Village'";
...
$sql = "SELECT * FROM  admindetails WHERE Village = '$Village'";
...
$sql = "SELECT * FROM dro_details WHERE Mandal = '$Mandal'";
